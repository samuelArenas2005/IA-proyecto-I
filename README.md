...
```bash
pip install eel ordered-set
```

> Nota: no existe `requirements.txt` en este repositorio, así que solo necesitas `eel` y `ordered-set` para ejecutar la interfaz y las búsquedas.
